...
from nwms.web.helpers.api import host_list, service_list, host_group, host_group_list, service_group_list, maintain_host_list
...
from nwms.web.views.admin.service import *
from nwms.web.views.admin.host import *
from nwms.web.views.admin.management import *
