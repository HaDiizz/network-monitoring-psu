...
def access_point_quarterly(year, month):
    ...
    if len(accessPoint_sla_second_month) == 0 :
        ...
        accessPoint_data_second_month = {accessPoint_name_second_month[i]: {"accessPoint_name": accessPoint_name_second_month[i], "accessPoint_sla": '{:.4f}'.format(round( accessPoint_sla_second_month[i], 4)),
    ...
    if len(accessPoint_sla_third_month) == 0 :
        ...
        accessPoint_data_third_month = {accessPoint_name_third_month[i]: {"accessPoint_name": accessPoint_name_third_month[i], "accessPoint_sla": '{:.4f}'.format(round( accessPoint_sla_third_month[i], 4)),
    ...
    if len(month_list_quarterly) >= 1:
        table_data[month_list_quarterly[0]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(accessPoint_sla_sum_first_month, 4)),
    ...
    if len(month_list_quarterly) >= 2:
        table_data[month_list_quarterly[1]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(accessPoint_sla_sum_second_month, 4)),
    ...
    if len(month_list_quarterly) >= 3:
        table_data[month_list_quarterly[2]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(accessPoint_sla_sum_third_month, 4)),
