...
def service_quarterly(year, month):
    ...
    if len(service_sla_second_month) == 0 :
        ...
        service_data_second_month = {service_name_second_month[i]: {"service_name": service_name_second_month[i], "service_sla": '{:.4f}'.format(round( service_sla_second_month[i], 4)),
    ...
    if len(service_sla_third_month) == 0 :
        ...
        service_data_third_month = {service_name_third_month[i]: {"service_name": service_name_third_month[i], "service_sla": '{:.4f}'.format(round( service_sla_third_month[i], 4)),
    ...
    if len(month_list_quarterly) >= 1:
        table_data[month_list_quarterly[0]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(service_sla_sum_first_month, 4)),
    ...
    if len(month_list_quarterly) >= 2:
        table_data[month_list_quarterly[1]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(service_sla_sum_second_month, 4)),
    ...
    if len(month_list_quarterly) >= 3:
        table_data[month_list_quarterly[2]] = {
            ...
            "avg_sla": '{:.4f}'.format(round(service_sla_sum_third_month, 4)),
