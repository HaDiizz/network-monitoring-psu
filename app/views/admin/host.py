...
def host_quarterly(year, month):
    ...
    host_data = {host_name[i]: {"host_name": host_name[i], "host_sla": '{:.5f}'.format(round( host_sla[i], 8)),
                                "host_ip": host_ip[i], "host_count": host_count[i]} for i in range(len(host_name))}

    host_data_first_month = {host_name[i]: {"host_name": host_name[i], "host_sla": '{:.5f}'.format(round( host_sla_first_month[i], 8)),
    ...
    if len(host_sla_second_month) == 0 :
        ...
        host_data_second_month = {host_name_second_month[i]: {"host_name": host_name_second_month[i], "host_sla": '{:.5f}'.format(round( host_sla_second_month[i], 8)),
    ...
    if len(host_sla_third_month) == 0 :
        ...
        host_data_third_month = {host_name_third_month[i]: {"host_name": host_name_third_month[i], "host_sla": '{:.5f}'.format(round( host_sla_third_month[i], 8)),
    ...
    if len(month_list_quarterly) >= 1:
        table_data[month_list_quarterly[0]] = {
            ...
            "avg_sla": '{:.5f}'.format(round(host_sla_sum_first_month, 8)),
    ...
    if len(month_list_quarterly) >= 2:
        table_data[month_list_quarterly[1]] = {
            ...
            "avg_sla": '{:.5f}'.format(round(host_sla_sum_second_month, 8)),
    ...
    if len(month_list_quarterly) >= 3:
        table_data[month_list_quarterly[2]] = {
            ...
            "avg_sla": '{:.5f}'.format(round(host_sla_sum_third_month, 8)),
